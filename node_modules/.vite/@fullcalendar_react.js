...
} from "./chunk-YXXCHSP3.js";
import "./chunk-YNUJHMXG.js";
import "./chunk-UXP3CFBU.js";
import {
  require_react
  ...
  FullCalendar2.prototype.render = function() {
    return React.createElement(CalendarDataProvider, { optionOverrides: this.props, calendarApi: this._calendarApi }, function(data) {
      return React.createElement(CalendarRoot, { options: data.calendarOptions, theme: data.theme, emitter: data.emitter }, function(classNames, height, isHeightAuto, forPrint) {
        return React.createElement("div", { className: classNames.join(" "), style: { height } }, React.createElement(CalendarContent, __assign({ isHeightAuto, forPrint }, data)));
      });
    });
  };
...
// dep:@fullcalendar_react
var fullcalendar_react_default = main_default;
export {
  BASE_OPTION_DEFAULTS,
  BASE_OPTION_REFINERS,
  BaseComponent,
  ...
  createPortal,
  createRef,
  fullcalendar_react_default as default,
  diffDates,
  diffDayAndTime,
  diffDays,
  diffPoints,
